...
class CBodyBasics
{
	...
	//new constants 2 seconds
	static const int		cTimeInterval = 2000;
public:
    /// <summary>
    /// Constructor
    /// </summary>
...
private:
	...
	void                    DrawHand(HandState handState, const D2D1_POINT_2F& handPosition, const D2D1_POINT_2F& trackPos, bool isLeft);
